...
Os resultados dos testes, que podem ser encontrados na etapa 2 do capítulo de experimentos (seção \ref{section_experimentos_macod}), mostraram que a estratégia número 3 representa a melhor relação entre qualidade do resultado e tempo de execução. Portanto, para todos os demais experimentos no PRM do capítulo \ref{chapter_experimentos}, esse foi o método de construção da solução utilizado.
